...
func (r *apibaseapporganizerweddingcreateInteractor) Execute(ctx context.Context, req entity.BaseReqFind) ([]entity.OrganizerWeddingData, int64, error) {
	var response = []entity.OrganizerWeddingData{}
	...
	err := dbhelpers.WithoutTransaction(ctx, r.outport, func(ctx context.Context) error {
		...
		res, count, err := r.outport.FindAllOrganizerWeddingData(ctx, req)
		if err != nil {
			return err
		}
